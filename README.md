...
- `/api/evidence` — official planning records, current-register metadata, SIPCOT leasehold allotment rates, the Sholinganallur 1 land reserve, the Siruseri combined commercial-asset reserve timeline, the Semmancheri secured-creditor industrial-land reserve timeline and source point, closed TNHB Sholinganallur apartment offers, the attributed approximate Siruseri footprint, the official-versus-open geometry audit, the archived Sholinganallur row, rights status, source provenance, crosswalk gaps and the guideline-value import contract
